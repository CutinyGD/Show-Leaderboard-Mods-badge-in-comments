...
void download_list() {
	...
	if (!downloaded) {
		...
		m_listener.setFilter(req.get("https://raw.githubusercontent.com/CutinyGD/Show-Leaderboard-Mods-badge-in-comments/main/names.txt"));
	}
}
